...
namespace OT.Common.EventBus.RabbitMQ.Implementation
{
    ...
    public sealed class EventBusRabbitMQ : IEventBus
    {
        ...
        public EventBusRabbitMQ(ILogger<EventBusRabbitMQ> logger, IMediator mediator, IServiceScopeFactory serviceScopeFactory)
        {
            _mediator = mediator; 
        ...
        private async Task Consumer_Received(object sender, BasicDeliverEventArgs e)
        {
            ...
            {
                _logger.LogError("Unable to process '{eventName}'. '{message}'",eventName ,ex.Message);
            }
        }
